...
public final class BuilderCommand implements CommandExecutor, TabCompleter {
    ...
    public BuilderCommand(TrackManager trackManager, MessageManager messages, CrashReporter crashReporter) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        try {
            ...
            crashReporter.reportException("BuilderCommand", args.length == 0 ? "help" : args[0], ex);
