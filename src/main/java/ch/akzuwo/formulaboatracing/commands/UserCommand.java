...
import ch.akzuwo.formulaboatracing.storage.StoredTime;
...
public final class UserCommand implements CommandExecutor, TabCompleter {
    ...
    public UserCommand(TrackManager trackManager, RaceManager raceManager, StorageManager storageManager, MessageManager messages) {
